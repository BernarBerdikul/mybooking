...
from .refactor_string import trim_string
...
class CreateTimestampMixin(models.Model):
    ...
    date_create = models.PositiveIntegerField(
        default=0, verbose_name=_("Время создания")
    )
...
class UpdateTimestampMixin(CreateTimestampMixin):
    ...
    date_update = models.PositiveIntegerField(
        blank=True, null=True, verbose_name=_("Время последнего изменения")
    )
