...
import traceback
import requests
from mybooking.utils.constants import ERROR_CHAT_ID
...
class TelegramFormatter(logging.Formatter):
    ...
    def format(self, record):
        ...
        s += "\n{attr}: {value}".format(attr="USER", value=record.request.user)
...
class AdminTelegramHandler(logging.Handler):
    ...
    def send_message(self, message):
        ...
        requests.post(f"{self.bot_url}sendMessage", json=prepared_data)
